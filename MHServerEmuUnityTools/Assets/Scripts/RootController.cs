...
namespace Assets.Scripts
{
    public class RootController : MonoBehaviour
    {
        ...
        void InstanciateCubes()
        {
            ...
            Transform cubeTransform = Instantiate(_cubePrefab, position, Random.rotation, transform).GetComponent<Transform>();
            ...
            cubeTransform = Instantiate(_cubePrefab, Vector3.zero, Random.rotation, transform).GetComponent<Transform>();
            cubeTransform.transform.localScale = size;
        }
    }
}