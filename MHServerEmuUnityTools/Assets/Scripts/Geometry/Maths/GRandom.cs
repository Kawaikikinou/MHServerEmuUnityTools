...
namespace Assets.Scripts.Geometry.Maths
{
    ...
    public class Rand : RandMwc
    {
        ...
        public float GetFloat()
        {
            ...
            // original code : return BitConverter.UInt32BitsToSingle(value) - 1.0f;
            byte[] bytes = BitConverter.GetBytes(value);
            return BitConverter.ToSingle(bytes, 0) - 1.0f;
        }
        ...
        public double GetDouble()
        {
            ...
            // original code : return BitConverter.UInt64BitsToDouble(value) - 1.0;
            byte[] bytes = BitConverter.GetBytes(value);
            return BitConverter.ToDouble(bytes, 0) - 1.0f;
        }
