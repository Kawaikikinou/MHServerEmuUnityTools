...
using Assets.Scripts.Geometry.Shapes.Prototypes;
using System;
...
namespace Assets.Scripts.Geometry
{
    public class Bounds
    {
        ...
        public void InitializeFromPrototype(BoundsPrototype boundsProto)
        {
            if (boundsProto == null)
            {
                UnityEngine.Debug.LogWarning("Anything trying to initialize Bounds should have a valid bounds prototype!");
        ...
        private void SetRadius(float radius)
        {
            switch (Geometry)
            {
                ...
                default:
                    UnityEngine.Debug.LogError($"Can't set the radius of a {Geometry}.");
                    break;
            }
        }
        ...
        public bool Intersects(Bounds other)
        {
            switch (other.Geometry)
            {
                ...
                default:
                    UnityEngine.Debug.LogWarning($"Unknown bounds geometry. Geometry={Geometry}, other.Geometry={other.Geometry}");
                    return false;
            }
        }
        ...
        public bool Intersects(Obb bounds)
        {
            switch (Geometry)
            {
                ...
                default:
                    UnityEngine.Debug.LogWarning($"Unknown bounds geometry. Geometry={Geometry}");
                    return false;
            }
        }
